...
const ProfileCard = withFlipAnimation(({ variant }: ProfileCardProps) => {
  let ref = useRef(null)
  ...
  return (
    <div
      className="z-10 mb-8 scale-100 transition-all duration-200 ease-out hover:z-50 xl:mb-0 xl:hover:scale-[1.15] cursor-pointer"
