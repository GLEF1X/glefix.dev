  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      <div className="flex space-x-1.5">
        <Link href="https://nextjs.org?ref=glefix.dev">
          <BrandIcon type="NextJS" className="h-5 w-5" />
        </Link>
        <Link href="https://tailwindcss.com?ref=glefix.dev">
          <BrandIcon type="TailwindCSS" className="h-5 w-5" />
        </Link>
        <Link href="https://www.prisma.io?ref=glefix.dev">
          <BrandIcon type="Prisma" className="h-5 w-5" />
        </Link>
        <Link href="https://www.typescriptlang.org?ref=glefix.dev">
          <BrandIcon type="Typescript" className="h-5 w-5" />
        </Link>
        <Link href="https://umami.is?ref=glefix.dev" className="pl-px">
